    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
         ...
         {{--   <li class="nav-item"><a href=""><i class="la la-group"></i>
                    ...
                    <span
                        class="badge badge badge-danger badge-pill float-right mr-2">{{\App\Models\Category::whereNot('parent_id', null) -> count()}}</span>
                </a>
                <ul class="menu-content">
            ...
            <li class=" nav-item"><a href="#"><i class="la la-television"></i><span class="menu-title" data-i18n="nav.templates.main">{{__('admin/sidebar.settings')}}</span></a>
                <ul class="menu-content">
                    <li><a class="menu-item" href="#" data-i18n="nav.templates.vert.main">وسائل التوصيل</a>
                        <ul class="menu-content">
                            <li><a class="menu-item" href="{{route('edit.shippings','free')}}"
                                   data-i18n="nav.templates.vert.classic_menu">توصيل مجانى </a>
                            </li>
                            <li><a class="menu-item" href="{{route('edit.shippings','inner')}}">توصيل داخلى</a>
                            </li>
